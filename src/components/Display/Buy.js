...
export default class Buy extends Component {
  ...
  deleteOnClick = (e) => {
    ...
    const newAllImages = this.state.allImages.filter((item) => {
      console.log(e)
  ...
  renderbuy() {
    ...
    {
      return(<h1 id="no-books">No Books found!</h1>)
    }
  }
